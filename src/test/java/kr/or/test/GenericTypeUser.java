...
public class GenericTypeUser {
	...
	public static void main(String[] args) {
		...
		System.out.println("입력된 ContainerKV 변수의 키 : " + nameK);
		System.out.println("입력된 ContainerKV 변수의 값 : " + nameV);
		...
		System.out.println("아이디:"+tableKV.get("userpw"));
		System.out.println("아이디:"+tableKV.get("username"));
		
		Container<String> container1 = new Container<String> ();//컨테이너1변수 : 스트링 홍길동
		container1.set("홍길동");
		
		Container<Integer> container2 = new Container<Integer> ();//컨테이너2변수 : 정수형 6
		container2.set(6);
