	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">			
			<ul class="bbsview_list">
				...
				<li class="bbs_hit">작성일 : <span><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${boardVO.regdate}"></fmt:formatDate></span></li>
				<li class="bbs_date">조회수 : <span class="right badge badge-danger">${boardVO.view_count}</span></li>
