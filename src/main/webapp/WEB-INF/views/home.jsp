            ...
            <div class="visualRoll">
                ...
                <div class="rollbtnArea">
                    <ul class="rollingbtn">
                        ...
                        <li class="rollstop"><a href="#" onclick="return false" class="stop"><img src="/resources/home/img/btn_roll_stop.png" alt="멈춤" /></a></li>
                        <li class="rollplay"><a href="#" onclick="return false" class="play"><img src="/resources/home/img/btn_roll_play.png" alt="재생" /></a></li>
                    </ul>
                </div><!-- //rollbtnArea -->
		...
		<div class="about_area">
			...
			<div class="about_box">
				<ul class="place_list box_inner clear">
					<li><a href="#" onclick="return false" onclick="$('.popup_base').css('height',$(document).height());$('.contact_pop').show();">
					...
					<li><a href="#" onclick="return false" onclick="$('.popup_base').css('height',$(document).height());$('.space_pop').show();">
							<img class="img_topplace" src="/resources/home/img/img_topplace02.jpg" alt="OOOO OOOOO" />
							<h3>OOOO OOOOO</h3>
							<p class="txt">OOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOOOOOO OOOOO.</p>
							<span class="view">VIEW</span></a>
					</li>
					<li><a href="#" onclick="return false" onclick="$('.popup_base').css('height',$(document).height());$('.program_pop').show();">
