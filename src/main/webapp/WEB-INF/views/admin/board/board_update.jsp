						...
						<div class="card card-warning">
							...
							<form role = "form" action="/admin/board/update" method="post">
								<div class="form-group">
									<label>제목</label> <input value= "${boardVO.title}" name="title" type="text" class="form-control"
										placeholder="Enter Title">
								</div>
								<div class="form-group">
									<label>내용</label>
									<textarea name="content" class="form-control" rows="3" placeholder="Enter ...">${boardVO.content}</textarea>
								</div>
								<div class="form-group">
									<label>작성자</label> <input value="${boardVO.writer}" name="writer" type="text" class="form-control"
                ...
                success:function(result){
                    if(result.data.length > 0){
                        ...
                        location.reload();
								...
								<label>아래 영역에 파일으 드래그 해서 업로드 가능</label>
								<!-- <form name="uploadForm" id="uploadForm"
									enctype="multipart/form-data" method="post"> -->
									<table class="table" width="100%" border="1px">
										<tbody id="fileTableTbody">
											<tr>
												<td id="dropZone" style="padding: 3rem; border-top: none;">
												</td>
											</tr>
										</tbody>
									</table>
